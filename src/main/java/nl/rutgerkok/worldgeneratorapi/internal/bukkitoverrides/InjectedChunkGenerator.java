...
public final class InjectedChunkGenerator extends ChunkGeneratorAbstract<GeneratorSettingsDefault> {
    ...
    // ADDED mrburgerUS, do not know if necessary.
    public InjectedChunkGenerator(WorldServer world, WorldChunkManager wcm, BaseTerrainGenerator baseChunkGenerator)
    {
        ...
        this.biomeGenerator = new BiomeGeneratorImpl(wcm);
        setBaseChunkGenerator(baseChunkGenerator);
    }
    ...
    public void buildBase(IChunkAccess ichunkaccess) {
        ...
        HeightMap.a(ichunkaccess, EnumSet.of(Type.WORLD_SURFACE_WG, Type.OCEAN_FLOOR_WG));
