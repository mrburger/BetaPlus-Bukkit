...
import com.mrburgerus.betaplus.world.beta.select.BetaPlusBiomeNew;
...
public class WorldChunkManagerBeta extends WorldChunkManager
{
    ...
    private static final Set<BiomeBase> biomeList = Sets.newHashSet(BIOMES_LIST);
    ...
    {
        return new BiomeBase[]{ Biomes.PLAINS, Biomes.DESERT, Biomes.FOREST, Biomes.SNOWY_TUNDRA, Biomes.SAVANNA, Biomes.SUNFLOWER_PLAINS, Biomes.DESERT_LAKES, Biomes.FLOWER_FOREST, Biomes.ICE_SPIKES};
    }
                ...
                for (int x = 0; x < CHUNK_SIZE; x++)
                {
                    for (int z = 0; z < CHUNK_SIZE; z++)
                    {
                        ...
                        if ((simulator.isBlockBeach(pos))
                                && yVals[x][z] <= BetaPlusPlugin.seaLevel + 2 && yVals[x][z] >= BetaPlusPlugin.seaLevel - 1)
                        {
    ...
    public List<BiomeBase> a() {
        return Lists.newArrayList(Biomes.PLAINS, Biomes.DESERT, Biomes.FOREST, Biomes.SNOWY_TUNDRA, Biomes.SAVANNA, Biomes.SUNFLOWER_PLAINS, Biomes.DESERT_LAKES, Biomes.FLOWER_FOREST, Biomes.ICE_SPIKES);
    }
}