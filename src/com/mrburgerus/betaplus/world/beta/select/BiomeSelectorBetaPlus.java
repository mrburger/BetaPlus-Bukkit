...
public class BiomeSelectorBetaPlus extends AbstractBiomeSelector
{
	...
	@Override
	public BiomeBase getBiome(double temperature, double humidity, double noiseSelect, TerrainType terrainType)
	{
		double ran;
		// NEW, confusing, but it works kinda.
		//ran = temperature * 0.9999999999;
		//temperature = (noiseSelect * 2.5) - 0.5; // TESTING swap
		// ORIGINAL, stopped use because of BiomeBase "striping", could be another issue.
		//ran = noiseSelect;
