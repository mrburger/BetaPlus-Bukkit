...
import com.mrburgerus.betaplus.world.beta.sim.BetaPlusSimulatorWCM;
...
public class WorldChunkManagerOverworldBeta extends WorldChunkManagerOverworld
{
	private static final BiomeBase[] BIOMES_LIST = buildBiomesList();
	public final BetaPlusSimulatorWCM simulator;
	...
	public WorldChunkManagerOverworldBeta(World world)
	{
		super(new BiomeLayoutOverworldConfiguration().a(new GeneratorSettingsOverworld()).a(world.worldData));
